...
export type PromptFn<T = void, Args = unknown> =
  | {
      prompt: (_args?: Args) => Promise<T | undefined>;
    }
  | undefined;

export function useDialogPrompt<T, Args = unknown>(
  ref: React.ForwardedRef<PromptFn<T, Args>>
) {
